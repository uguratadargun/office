...
export const SETTINGS: SettingEntry[] = [
  ...
  { id: 'set-effort', section: 'Agents & Models', group: 'Defaults', label: 'Default reasoning effort', keywords: 'effort reasoning thinking level low medium high xhigh max cost tokens', keys: ['defaultEffort'] },
  ...
  { id: 'set-worker-cap', section: 'Agents & Models', group: 'Limits', label: 'Default worker token budget', keywords: 'worker token cap budget ephemeral slack webhook unlimited breaker cost', keys: ['defaultWorkerTokenCap'] },
  ...
  { id: 'set-clear-on-done', section: 'Agents & Models', group: 'Limits', label: 'Fresh context per card', keywords: 'clear conversation thread card done sign off signed reset context fresh start memory transcript resume', keys: ['clearOnDone'] },
