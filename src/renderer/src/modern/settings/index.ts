...
export const SETTINGS: SettingEntry[] = [
  ...
  { id: 'set-appearance', section: 'General', group: 'Appearance', label: 'Theme', keywords: 'light dark colour color', keys: [] },
  { id: 'set-uimode', section: 'General', group: 'Appearance', label: 'Interface', keywords: 'pixel classic modern ui switch', keys: ['uiMode'] },
